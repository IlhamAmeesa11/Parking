...
<nav class="navbar navbar-expand-lg navbar-light bg-info p-3">
  ...
  <div class="container-fluid">
    ...
    <nav  id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light  p-4 " >
      ...
      <div class="container text-center mt-5 w-50 p-4 bg-light">
       <button class="btn btn-light bg-light p-3 fw-bold ">Lisense Plate</button>
       <div class="form-floating my-3">
  <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
  <label for="floatingInput">Lisense Plate</label>
    <button type="submit" class="btn btn-primary pw-bold mt-3 ">Search</button>
     ...
     <hr>
        ...
        <div class="row mb-2" >
          <label for="Stuid" class="col-sm-4 col-form-label fw-bold">Lisenese Plate</label>
          <div class="col-sm-8">
          <input type="password" class="form-control" id="stuid">
          </div>
        </div>
        <div class="row mb-3" >
          <label for="password" class="col-sm-4 col-form-label fw-bold">Name Lastname</label>
          <div class="col-sm-8 mr-5">
          <input type="password" class="form-control" id="password">
          </div>
        </div>
        <div class="row mb-3" >
          <label for="password" class="col-sm-4 col-form-label fw-bold">ID</label>
          <div class="col-sm-8 mr-5">
          <input type="password" class="form-control" id="password">
          </div>
        </div>
        ...
        <P class="mt-3 fw-bold">Mistake time</P>
      
        <div class="container mr-5">
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="" value="mistake1">
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="" value="mistake1">
          </div>
          ...
          <div class="container">
            ...
            <button type="submit" class="btn btn-primary pw-bold mt-3 ">Record</button>
          </div>
</div>
        </div> 
  ...
  <footer class="pt-3 d-flex bg-info justify-content-between p-3" >Parking Management System</footer>
